...
//
// Compilation : g++ `pkg-config opencv --cflags` convolution.cpp median.cpp sobel.cpp ../utils/chrono.cpp ../utils/sort.cpp ../utils/utils.cpp RK_Sabre_v4.cpp -o RK_Projet `pkg-config opencv --libs` -std=c++14
